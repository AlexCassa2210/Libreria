<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="biblioteca.aspx.cs" Inherits="Libreria.biblioteca1" %>
...
<form id="form1" runat="server">
        ...
        <div>
            <h2 class="tittle">TODOS LOS LIBROS</h2>
            <div class="contenedor">
                <div class="row contenedor-grid">
                    <asp:Repeater ID="repBiblioteca" runat="server">
                        <ItemTemplate>
