<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="buscar.aspx.cs" Inherits="Libreria.Servicios.Buscar" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="buscar contenedor clearfix">
            <asp:TextBox runat="server" id="txtBuscar" style="height:30px;"/>
            <asp:Button Text="Buscar" class="boton" runat="server" id="tbnBuscar" /><%--onClick="btnContactar_Click"--%>
        </div>

        <div>
            <h2 class="tittle">LIBROS ENCONTRADOS</h2>
            <div class="contenedor">
                <div class="row contenedor-grid">
                    <asp:Repeater ID="repBuscar" runat="server">
                        <ItemTemplate>
